...
public class OOP_Project 
{
    ...
    public static void main(String[] args) 
    {
        ...
        while (loop1) {
            int index = -1;         // The index that indicates the specific user in the vector. -1 means user is not found in the vector.
            ...
            switch (x) // Switch to corresponding case according to the input entered by the users
            {
                case 1:     // User = Admin
                    ...
                    // Authenticate the user by comparing the entered username and password with the attributes stored in the vector.
                    // It will return the searching result to "login", whereby indicating the status of login.
                    // Once it is found in the vector, "login" is set to true and assign "index" to current indexing counter, "i" and the loop terminates.
                    ...
                    // Check the login status. Only if it is true, then the admin can use the services provided inside.
                    if (login) {
                        boolean loop2 = true;
                        // Start Admin Menu
                        while (loop2) {
                            ...
                            switch (x) 
                            {
                                case 1:
                                    while (loop3) 
                                    {
                                        ...
                                        {
                                            case 1:     // Add Doctor
                                                String n, usn, pswd, adrs, specialty, qualification, _gender, _ic, _id,_phone;
                                                int _age;
                                                // Show the login status of admin (overloading methods)
                                                dispLogin(adminVector, index);
                                                Scanner input = new Scanner(System.in);
                                                // Ask the user to input the doctor's information
                                                System.out.println("Enter the new doctor with filling out the following fields : ");
                                                System.out.print("Username: ");
                                                usn = input.nextLine();
                                                System.out.print("Password: ");
                                                pswd = input.nextLine();
                                            ...
                                            case 2:     // Delete Doctor
                                                ...
                                                System.out.println("========================================================================");
                                                System.out.println(String.format("%-4s", "No") + String.format("%-7s", "Dr ID") + String.format("%-35s", "Name") + 
                                                                    String.format("%-5s", "Age") + String.format("%-10s", "Gender") + String.format("%-15s", "IC") +
                                                                    String.format("%-15s", "Phone") + String.format("%-45s", "Address") +
                                                                    String.format("%-15s", "Specialty") + String.format("%-25s", "Qualification"));
                                    ...
                                    while (loop3) 
                                    {
                                        ...
                                        switch (x) 
                                        {
                                            ...
                                            case 2:     // Delete medicine
                                                ...
                                                System.out.println("========================================================================");
                                                System.out.println(String.format("%-4s", "No") + String.format("%-15s", "Medicine Code") + 
                                                                    String.format("%-15s", "Medicine Name") + String.format("%-25s", "Description") + 
                                                                    String.format("%-10s", "Quantity") + String.format("%-10s", "Price(RM)"));
                                    ...
                                    while (loop3) 
                                    {
                                        ...
                                        switch (x) 
                                        {
                                            case 1:         // Add Admin
                                                ...
                                                int _age;
                                                Scanner input = new Scanner(System.in);
                                                System.out.println("Enter the new admin with filling out the following fields : ");
                                                System.out.print("Username: ");
                                                usn = input.nextLine();
                                                System.out.print("Password: ");
                                                pswd = input.nextLine();
                                            ...
                                            case 2:     // Delete admin
                                                ...
                                                System.out.println("========================================================================");
                                                System.out.println(String.format("%-4s", "No") + String.format("%-10s", "Admin ID") + String.format("%-35s", "Name") + 
                                                                    String.format("%-5s", "Age") + String.format("%-10s", "Gender") + String.format("%-15s", "IC") +
                                                                    String.format("%-15s", "Phone") + String.format("%-45s", "Address"));
                                                for (int i = 0; i < adminVector.size(); i++)
                                                {
                                ...
                                case 5:     // Display system summary
                                    System.out.println("Total number of patient registerd the system : " + patientVector.size());
                            ...
                            switch (x) 
                            {
                                ...
                                case 4:     // Prescribe to the patient
                                    if(medicineVector.size() == 0)  // No medicine in the system
                                    {
                                        ...
                                        System.out.println("Please inform admins to add some medicine in the the system.");
                                        break;
                                    }
                                    
                                    if(doctorVector.get(index).getPatientListSize() != 0)   // If the doctor has a patient
                                    {
                                        System.out.println("========================================================================");
                                        System.out.println("\t\t\t Patient List");
                                        System.out.println("========================================================================");
                                        ...
                                        doctorVector.get(index).prescribe(medicineVector.get(m_index-1), patientVector.get(pIndex-1), m_quantity);
                                        // update medicine quantity in the medicine vector
                                        medicineVector.get(m_index-1).setQuantity(medicineVector.get(m_index-1).getQuantity()-m_quantity);
                                    }
                                    else
                                        System.out.println("You do not have any patient yet!\n");
                                    break;
                                ...
                                while (loop2) 
                                {
                                    ...
                                    switch (x) 
                                    {
                                        ...
                                        case 3:    // Book appointment
                                            ...
                                            System.out.println("\t\t\t Doctor List");
                                            System.out.println("========================================================================");
                                            System.out.println(String.format("%-4s", "No") + String.format("%-35s", "Name") + 
                                                                String.format("%-10s", "Gender") + String.format("%-15s", "Specialty") + 
                                            ...
                                            Appointment appoint = new Appointment(year,day,month,hour,minute,doctorVector.get(d_index-1),patientVector.get(index));
                                            // Check whether the booking date and time clashed or not
                                            boolean status = patientVector.get(index).bookAppointment(doctorVector.get(d_index-1), appoint);
                                            // If the appointment is not clashed, then add the appointment into the vector
                                            if(status == true)
                                            {
                                        ...
                                        case 4:     // Make payment
                                            ...
                                            {
                                                System.out.println("Payment to be made : RM" + String.format("%.2f", patientVector.get(index).getPayment()));
                                                ...
                                                while(payment_loop)
                                                {
                                                    if(amount > patientVector.get(index).getPayment())
                                                    {
                                                        ...
                                                        System.out.println("Thank you for your payment! Here is your change RM" + String.format("%.2f", change));
                                                        payment_loop = false;
                                                    }
                                                    ...
                                                    {
                                                        System.out.println("The amount entered is not enough. Please enter the add-on amount");
